    ...
    return (
        <div className={styles.container}>
            <Head>
                ...
                />
                <meta property="og:title" content="MPT Server - Malaysia Prayer Time API"/>
                <meta property={"og:image"}
                      content={"https://res.cloudinary.com/iqfareez-cloud/image/upload/v1687052462/1_r0mixv.png"}/>
